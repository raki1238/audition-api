...
/*
 * SystemException class to manage all the exception messages and converting them into
 * ErrorResponses with statusCode, title, detail and few more properties.
 */
